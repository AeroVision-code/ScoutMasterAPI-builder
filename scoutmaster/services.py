class Services:
    def services(self, lang=None):
        ...
        Args:
            lang (str, optional): Language code — 'en', 'nl', 'de', or 'fr'.
    ...
    def project_services(self, project_id, lang=None):
        """
    ...
    def project_service_add(self, project_id, service_id):
        """
    ...
    def project_service_remove(self, project_id, service_id):
        """
